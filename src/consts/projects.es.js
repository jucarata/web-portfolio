export const projects = [
  {
    name: "SGIRS",
    description: "SGIRS es una plataforma digital de la Alcaldía de Santiago de Cali que permite a los establecimientos comerciales y empresas registrar, de manera semestral, los residuos que generan y el tratamiento que reciben. A través de una encuesta semestral, los negocios informan a la Alcaldía sobre la cantidad y los tipos de residuos producidos, así como su disposición final, incluyendo su recolección por gestores autorizados o su destinación a procesos de reciclaje.\n\nEn este proyecto me desempeñé como desarrollador backend, encargado de la implementación de la lógica de autenticación de usuarios, la lógica de negocio de la aplicación, así como del diseño e implementación de la base de datos, tanto a nivel transaccional como dimensional.",
    state: "Finished",
